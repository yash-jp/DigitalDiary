...
class Contact extends Component {
  ...
  handleDeleteEvent = (contactID) => {
    ...
    //   axios.delete('https://gladiator-digital-diary-server.herokuapp.com/api/contacts',body,config)
    //   .then(res=>{
  ...
  handleBookMarkEvent = (id) => {
    ...
    axios
      .put(
        "https://gladiator-digital-diary-server.herokuapp.com/api/contacts/toggleBookmark",
        { contactID: id },
        config
      )
      .then((res) => {
